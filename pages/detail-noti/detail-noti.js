...
var DetailNotiPage = /** @class */ (function () {
    function DetailNotiPage(httpClient, navCtrl, navParams, httpNative) {
        var _this = this;
        ...
        this.httpNative.get('https://do4go.com' + this.urlNoti + '?view=dogo.json', {}, {}).then(function (res) {
            var article = JSON.parse(res.data).article;
            console.log(article);
            if (typeof article !== 'undefined' && article !== null) {
                _this.detailNoti = article;
    ...
    DetailNotiPage = __decorate([
        ...
        __metadata("design:paramtypes", [Http, NavController, NavParams, HTTP])
    ], DetailNotiPage);
