...
var PayxuPage = /** @class */ (function () {
    function PayxuPage(navCtrl, navParams, cservice, storage, cusService, tb, viewCtrl, alertCtrl) {
        var _this = this;
    ...
    PayxuPage.prototype.toProduct = function (r) {
        var Product = ({
            id: r.first_variant,
            title: r.title,
    ...
    // pay
    PayxuPage.prototype.productTapped = function (id, price) {
        var _this = this;
